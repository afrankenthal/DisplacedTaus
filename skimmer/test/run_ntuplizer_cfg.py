...
process.load('DisplacedTaus.skimmer.myMETFilters_cff')
...
if options.year == 2016:
    ...
    from DisplacedTaus.skimmer.myBTagging_cff import addBTaggingAK4CHS
...
from DisplacedTaus.skimmer.muonsFromdSA_cff import * 
...
from DisplacedTaus.skimmer.ntupleAnalyzer_cfi import ntupleAnalyzer
process.ntuples = ntupleAnalyzer.clone(
